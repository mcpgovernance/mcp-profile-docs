...
project = u'Marine Community Profile'
manual = u'Manual'
copyright = u'2013 Marine Community Profile Governance Committee'
...
# pixels large.
html_favicon = '../themes/mcp/static/favicon.ico'
...
htmlhelp_basename = 'MarineCommunityProfileManual'
